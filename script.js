...
// Configuration for Manual Fallback (Restored for ALL events to prevent crash)
const manualConfigs = {
...
// Mappings for Scrambo and TwistyPlayer
const eventMap = {
...
// --- Scramble & Visualization Logic (Robust Fallback) ---
...
async function updateTwistyPlayer() {
    ...
    if (config && player && activeTool === 'scramble') {
        ...
        try {
            ...
            if (player.puzzle !== config.puzzle) player.puzzle = config.puzzle;
